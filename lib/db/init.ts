...
const POST_BASELINE_COLUMN_MIGRATIONS: Array<{
  ...
  // 0062_release_published_at (single transactional migration: its five
  // columns are always present or absent together on real databases).
  { folderMillis: 1789516900000, table: "releases", column: "published_at" },
  {
    folderMillis: 1789516900000,
    table: "releases",
    column: "changelog_session_id",
  },
  { folderMillis: 1789516900000, table: "releases", column: "push_to_github" },
  { folderMillis: 1789516900000, table: "releases", column: "finalized_at" },
  { folderMillis: 1789516900000, table: "releases", column: "finalize_errors" },
];
