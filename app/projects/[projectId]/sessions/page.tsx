...
export default function SessionsPage() {
  ...
  // Resolved here, not inside the effect below: reading the translator from
  // the loader would make `t` an effect dependency, while a resolved string
  // compares by value and leaves the load keyed on the project alone.
